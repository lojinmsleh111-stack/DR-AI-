...
# قناة اللوقز الخاصة بالإدارة (سجل كل الطلبات والقرارات)
...
QUESTIONS = [
    ...
    ("roblox_main", "3️⃣ اسم حسابك الأساسي في روبلوكس", "اسم الحساب الاساسي :"),
    ("roblox_short", "4️⃣ اختصار الحسابك روبلوكس : ", "Display Name / اليوزر..."),
    (
        "pledge",
